...
def test_relay_contract_versions_and_product_paths_stay_current():
    ...
    assert RELAY_OPENAPI_COMMIT == "55e12f23fdb559e23e54e4f386a77fd397293834"
...
def test_split_buttons_lifts_the_block_and_keeps_the_words():
    ...
    assert split_buttons(sticky) == ("", {"type": "buttons", "items": [{"label": "Next"}], "one_time": False}, None)
    assert split_buttons("```buttons\n{\"one_time\": \"no\", \"items\": [{\"label\": \"Next\"}]}\n```")[2] == "one_time must be true or false"
